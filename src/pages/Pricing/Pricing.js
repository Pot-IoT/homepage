    ...
    return (
        <div className='pricing-page-root'>
            <div className='pricing-top-section' id='pricing-top-section'>
                <h3 class="heading color-neutral600">Pricing</h3>
                <div class="text-top color-neutral600">Pot-Iot Platform is free to use for <h2> 3 MONTHS </h2> The pricing of Basic plan is shown as below, and if you want more capacity or even a customized feature, please contact us to know more details: contact_us@pot-iot.com.</div>
                <br />
                <Link to='/signup'>
                ...
                <Grid container spacing={2} className={classes.grid}>
                    <Grid item xs={12} md={6}>
                        <Paper className={classes.paper} style={{ textAlign: 'left', paddingLeft: "50px", paddingRight: "50px" }}>
                            <h1 class='color-neutral600' style={{ fontSize: '24px' }}>Basic</h1>
                            <h1 style={{ color: 'black', width: '100%', fontSize: '48px', padding: '1rem' }}>$100/month</h1>
                            <div class='color-neutral600' style={{ alignContent: 'flex-start', width: '100%', fontSize: '16px' }}>
